...
export function SchichtvorlagenDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = false, enablePhotoLocation = true }: SchichtvorlagenDialogProps) {
    ...
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="anzahl_mitarbeiter">Benötigte Anzahl Mitarbeiter</Label>
            <Input
              id="anzahl_mitarbeiter"
              type="number"
              value={fields.anzahl_mitarbeiter ?? ''}
              onChange={e => setFields(f => ({ ...f, anzahl_mitarbeiter: e.target.value ? Number(e.target.value) : undefined }))}
            />
          </div>
          <div className="space-y-2">
